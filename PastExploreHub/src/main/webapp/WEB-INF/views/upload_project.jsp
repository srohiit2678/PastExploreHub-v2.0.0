...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/upload_project.css">
<link rel="stylesheet"
...
<body>
	<div class="dashboard-container">
		...
		<nav class="sidebar">
			...
			<ul class="menu">
				<li><a href="/pastexplorehub/user/home"><i
						class="fas fa-home"></i> Porjects</a></li>
				<li><a href="/pastexplorehub/user/student-profile"><i
						class="fas fa-user"></i> Profile</a></li>
				<li class="active"><a href="/pastexplorehub/userupload-project"><i
						class="fas fa-upload"></i> Upload Projects</a></li>
				<li class="logout-item"><a
					href="/pastexplorehub/user-api/login"><i
			...
			<div class="content-section">
				<form id="projectForm" action="/pastexplorehub/project/project-details" method="post" enctype="multipart/form-data">
					...
					<label for="mentorName" class="required">Select Mentor:</label> <select id="mentorName" name="guideId" required>
						...
						<%
						    List<TeacherDTO> teachersAsGuid = (List<TeacherDTO>)session.getAttribute("teachersAsGuid");
						
						for(TeacherDTO teacher:teachersAsGuid){
						//de-buged 
