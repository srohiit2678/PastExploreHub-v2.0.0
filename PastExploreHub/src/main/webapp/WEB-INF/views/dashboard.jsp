...
<table>
    ...
    <tbody>
        ...
        %>
            <tr>
                ...
                <td>
                    <button class="view" type="submit" name="id"
						onclick="openPopup(<%=project.getProjectId()%>)">
    ...
    <div class="popup-content">
        <span class="close-btn" onclick="closePopup()" style="text-align:center; cursor:pointer;">
             ----------- tap here to close ----------- 
        </span>
